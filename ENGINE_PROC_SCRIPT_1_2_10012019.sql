/****** Object:  StoredProcedure [DEV00].[BB_BALANCE_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  StoredProcedure [DEV00].[BB_CASH_TRANSACTION_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [DEV00].[BB_ELA_BANK_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [DEV00].[BB_ELA_PATH_FIND]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [DEV00].[BB_ELA_PATH_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [DEV00].[BB_ENTRY_VALIDATIONS]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [DEV00].[BB_IE_TRANSACTION_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	SELECT @BATTYP = YBATTYP_0 from YBBDETAILTEM Where YTRANSNBR_0 = @MINTRANSNBR AND YBATNBR_0 = @YBATNBR	
		...
		BEGIN -- 3
			...
			BEGIN -- 4.1
				...
				SELECT DISTINCT @FCY1 = YFCY_0 FROM YBBDETAILTEM WHERE YTRANSNBR_0 = @MINTRANSNBR AND YBATNBR_0 = @YBATNBR
...
END -- 1
GO
/****** Object:  StoredProcedure [DEV00].[BB_SITE_VALIDATION]    Script Date: 10/01/2019 3:08:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
